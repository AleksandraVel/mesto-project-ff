...
export const getUserInfo = () => {
  ...
  export function deleteCard(cardId) {
    const deletePromise = fetch(`https://nomoreparties.co/v1/wff-cohort-13/cards/${cardId}`, {
      method: "DELETE",
      headers: {
        authorization: '85a0fd17-5682-458d-9fc8-8af543f36b97',
        'Content-Type': 'application/json'
    ...
    deletePromise
      .then(() => {
        card.remove();
        removeCardButton.removeEventListener("click", () => deleteCard(card, information, removeCardButton));
      })
      .catch((err) => {
        console.log(err);
      });
